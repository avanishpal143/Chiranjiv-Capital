...
export const KMP = [
  {
    ...
    shortBio: 'Compliance Officer managing regulatory compliance and secretarial matters.',
    fullBio: 'Keshav Ahuja serves as the Compliance Officer, overseeing legal and regulatory compliances, secretarial mandates, and corporate actions under SEBI and the Companies Act.',
    expertise: ['Compliance Management', 'Regulatory Filings', 'Corporate Governance'],
    experience: '2+ Years',
    education: 'B.Com | Compliance Officer',
    initials: 'KA',
    color: '#2848B8',
    photo: '',
  },
